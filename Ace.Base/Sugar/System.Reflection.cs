...
public static class Member
{
	...
	public static IEnumerable<MemberInfo> EnumerateMembers(this Type type, BindingFlags bindingFlags)
		=> type.BaseType?.EnumerateMembers(bindingFlags).Concat(type.GetMembers(bindingFlags | BindingFlags.DeclaredOnly))
	...
	public static IEnumerable<MemberInfo> EnumerateMember(this Type type, string name, BindingFlags bindingFlags)
		=> type.BaseType?.EnumerateMember(name, bindingFlags).Concat(type.GetMember(name, bindingFlags | BindingFlags.DeclaredOnly))
