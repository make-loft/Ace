...
namespace Aero.Markup
{
    public static class Attacher
    {
        ...
        public static Set GetContextTriggers(VisualElement element)
        {
            var contextTriggers = (Set) element.GetValue(ContextTriggersProperty.XamarinBase);
            ...
            element.SetValue(ContextTriggersProperty.XamarinBase, contextTriggers);
